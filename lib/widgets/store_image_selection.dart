...
class StoreImageSelection extends StatelessWidget {
  late final DataController userProvider;
  final String id;
  StoreImageSelection({Key? key, required this.id}) : super(key: key) {
  ...
  void removeProfile() async {
    var res = await userProvider.uploadServiceCenterPhoto(image: null, id: id);
    ...
    try {
      ...
      if (photo != null) {
        ...
        if (thumbnail.isNotEmpty) {
          var res = await userProvider.uploadServiceCenterPhoto(
            image: thumbnail,
            id: id,
          );
          Navigator.of(GlobalVariable.navState.currentContext!).pop(res);
